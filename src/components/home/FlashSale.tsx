...
export default function FlashSale() {
  ...
  // While loading we render NOTHING (no skeleton). Flash sales are usually
  // absent, so a tall skeleton that then collapsed to null caused a large
  // upward layout shift (CLS) of everything below it. Keeping the height at 0
  // until we know there is an active sale avoids that shift entirely.
